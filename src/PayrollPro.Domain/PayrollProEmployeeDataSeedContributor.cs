            ...
            switch (company.Name)
            {
                case "TechNova Solutions":
                    return new[]
                    {
                        ...
                        CreateEmployee(company.Id, "Michael", "Davis", "michael.davis@technova.com", "+1-555-0103", "TN003", "Engineering", "DevOps Engineer", 88000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-180)),
                        ...
                        CreateEmployee(company.Id, "Lisa", "Taylor", "lisa.taylor@technova.com", "+1-555-0106", "TN006", "Engineering", "Frontend Developer", 75000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-90)),
                        ...
                        CreateEmployee(company.Id, "Kevin", "Murphy", "kevin.murphy@technova.com", "+1-555-0111", "TN011", "Engineering", "Software Engineer", 72000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-75)),
                        CreateEmployee(company.Id, "Rachel", "Thompson", "rachel.thompson@technova.com", "+1-555-0112", "TN012", "Product", "Product Designer", 68000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-60))
                    };
                ...
                case "Global Manufacturing Corp":
                    return new[]
                    {
                        ...
                        CreateEmployee(company.Id, "Jessica", "White", "jessica.white@globalmanuf.com", "+1-555-0202", "GM002", "Engineering", "Manufacturing Engineer", 78000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-300)),
                        ...
                        CreateEmployee(company.Id, "Daniel", "Lewis", "daniel.lewis@globalmanuf.com", "+1-555-0205", "GM005", "Maintenance", "Maintenance Technician", 52000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-365)),
                        CreateEmployee(company.Id, "Nicole", "Walker", "nicole.walker@globalmanuf.com", "+1-555-0206", "GM006", "Safety", "Safety Officer", 62000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-200)),
                ...
                case "HealthCare Plus":
                    return new[]
                    {
                        ...
                        CreateEmployee(company.Id, "Dr. Maria", "Lopez", "maria.lopez@healthcareplus.com", "+1-555-0302", "HC002", "Medical", "Cardiologist", 185000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-600)),
                        ...
                        CreateEmployee(company.Id, "Thomas", "Scott", "thomas.scott@healthcareplus.com", "+1-555-0304", "HC004", "Administration", "Healthcare Administrator", 85000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-400)),
                        ...
                        CreateEmployee(company.Id, "Brian", "Adams", "brian.adams@healthcareplus.com", "+1-555-0306", "HC006", "IT", "Healthcare IT Specialist", 72000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-250)),
                ...
                case "EcoGreen Energy":
                    return new[]
                    {
                        ...
                        CreateEmployee(company.Id, "Christina", "Turner", "christina.turner@ecogreen.com", "+1-555-0404", "EG004", "Environmental", "Environmental Compliance Officer", 75000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-180)),
                        CreateEmployee(company.Id, "Jason", "Phillips", "jason.phillips@ecogreen.com", "+1-555-0405", "EG005", "Maintenance", "Turbine Technician", 65000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-200)),
                        ...
                        CreateEmployee(company.Id, "Marcus", "Williams", "marcus.williams@ecogreen.com", "+1-555-0411", "EG011", "Operations", "Site Coordinator", 55000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-45)),
                        CreateEmployee(company.Id, "Jennifer", "Brown", "jennifer.brown@ecogreen.com", "+1-555-0412", "EG012", "Engineering", "Junior Engineer", 58000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-30))
                    };
                ...
                case "Financial Advisory Group":
                    return new[]
                    {
                        ...
                        CreateEmployee(company.Id, "Patricia", "Sanchez", "patricia.sanchez@financialadvisory.com", "+1-555-0502", "FA002", "Investment", "Investment Analyst", 85000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-300)),
                        ...
                        CreateEmployee(company.Id, "Jeffrey", "Reed", "jeffrey.reed@financialadvisory.com", "+1-555-0505", "FA005", "Research", "Research Analyst", 78000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-250)),
                        ...
                        CreateEmployee(company.Id, "Michael", "Jones", "michael.jones@financialadvisory.com", "+1-555-0511", "FA011", "Advisory", "Financial Advisor", 85000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-90)),
                        CreateEmployee(company.Id, "Sarah", "Davis", "sarah.davis@financialadvisory.com", "+1-555-0512", "FA012", "Research", "Market Research Analyst", 62000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-65))
                    };
                ...
                case "Creative Design Studio":
                    return new[]
                    {
                        ...
                        CreateEmployee(company.Id, "Nancy", "Cooper", "nancy.cooper@creativedesign.com", "+1-555-0602", "CD002", "Design", "Senior Graphic Designer", 72000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-300)),
                        CreateEmployee(company.Id, "Jonathan", "Richardson", "jonathan.richardson@creativedesign.com", "+1-555-0603", "CD003", "Design", "Web Designer", 65000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-250)),
                        ...
                        CreateEmployee(company.Id, "Linda", "Torres", "linda.torres@creativedesign.com", "+1-555-0606", "CD006", "Project Management", "Project Coordinator", 58000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-150)),
                ...
                case "Logistics Express Inc":
                    return new[]
                    {
                        ...
                        CreateEmployee(company.Id, "Betty", "Brooks", "betty.brooks@logisticsexpress.com", "+1-555-0702", "LE002", "Dispatch", "Dispatch Supervisor", 58000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-300)),
                        ...
                        CreateEmployee(company.Id, "Dorothy", "Sanders", "dorothy.sanders@logisticsexpress.com", "+1-555-0704", "LE004", "Customer Service", "Customer Service Representative", 38000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-150)),
                ...
                case "Restaurant Chain Co":
                    return new[]
                    {
                        ...
                        CreateEmployee(company.Id, "Janet", "Jenkins", "janet.jenkins@restaurantchain.com", "+1-555-0802", "RC002", "Operations", "Store Manager", 52000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-300)),
                        ...
                        CreateEmployee(company.Id, "Gloria", "Powell", "gloria.powell@restaurantchain.com", "+1-555-0804", "RC004", "Service", "Front of House Manager", 42000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-250)),
                        ...
                        CreateEmployee(company.Id, "Marie", "Patterson", "marie.patterson@restaurantchain.com", "+1-555-0806", "RC006", "Service", "Server", 28000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-150)),
                ...
                case "Educational Resources Ltd":
                    return new[]
                    {
                        ...
                        CreateEmployee(company.Id, "Joyce", "Foster", "joyce.foster@educationalresources.com", "+1-555-0902", "ER002", "Curriculum", "Curriculum Developer", 68000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-400)),
                        ...
                        CreateEmployee(company.Id, "Frances", "Bryant", "frances.bryant@educationalresources.com", "+1-555-0904", "ER004", "Content", "Content Creator", 55000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-250)),
                ...
                case "Construction Masters":
                    return new[]
                    {
                        ...
                        CreateEmployee(company.Id, "Virginia", "Hamilton", "virginia.hamilton@constructionmasters.com", "+1-555-1002", "CM002", "Engineering", "Site Engineer", 78000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-400)),
                        ...
                        CreateEmployee(company.Id, "Judith", "Sullivan", "judith.sullivan@constructionmasters.com", "+1-555-1004", "CM004", "Safety", "Safety Coordinator", 62000, EmployeeStatus.OnLeave, DateTime.UtcNow.AddDays(-250)),
