...
{
    [DbContext(typeof(PayrollProDbContext))]
    [Migration("20251006040425_AddExtendedEmployeeFields")]
    partial class AddExtendedEmployeeFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayrollPro.Companies.Company", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<bool>("AutoProcessPayroll")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PayrollPro.Employees.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("BillableByDefault")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PayrollPro.Payrolls.PayrollRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PayrollPro.Timesheets.Timesheet", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PayrollPro.Employees.Employee", b =>
                {
                    b.HasOne("PayrollPro.Companies.Company", "Company")
                        .WithMany("Employees")
